...
import { Blue, Red } from "./components/TextColors";
...
export default function Home() {
  return (
    <article className="w-[min(70ch,100%)] m-auto">
      <h2>About</h2>
      <p>
        This app is a tool that lets you generate student report comments based
        on the pre-defined "traits".
      </p>
      <p>
        Each trait describes a single characteristic of a student. Does the
        student come to class on time? Can the student solve word problems? And
        so on. Traits can be either <strong>inactive (grey)</strong>,{" "}
        <strong>positive (blue)</strong> and <strong>negative (red)</strong>. An
        inactive trait <em>asks a question</em> about a student, a positive
        trait <em>describes</em> a student, and a negative trait <em>tells</em>{" "}
      ...
      <p>
        ...
        either commending the students or suggesting improvements. For example,
        the trait <em>"Has good inquiry skills"</em> has the following comments:
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          <ul>
            <li>
              persevering with more difficult problems and thinking of different
              strategies to approach the question
            </li>
            <li>
      ...
      <p>
        ...
        choose commending and suggesting comments from the pool and show them to
        the user to review and use.
      </p>
      <h2>Howto</h2>
      <p>
        Click the <strong>Commments</strong> button on the top menu to generate
        comments.
      </p>
      <h3>Gender</h3>
      <p>
      ...
      <p>
        ...
        comments. Fill the boxes in and click the <strong>label</strong> buttons
        to either print a commending (good) comment or suggesting (bad) comment.
        For example, the picture below shows a student who achieved well in the
        Algebra topic and needs improvement in the Measurement topic.
      </p>
      ...
      <p>
        You can mark as many traits as positive or negative, but note that only{" "}
        <strong>up to 16</strong> of them (eight positives and eight negatives)
        will populate the comment pool due to the current restriction in the
        database.
      </p>
      <p>
      ...
      <p>
        ...
        present participle form (i.e. adding "ing" at the end), which you need
        to do manually. I do not have plans to write the logic any time soon,
        you are welcome to suggest me{" "}
        <A
          blank
      ...
      <h2>Updates</h2>
      <p>
        The app is still in its alpha stage, and there may be some bugs and many
        traits are missing their comments. I expect every trait will have at
        least one positive and one negative comment before September.
      </p>
